...
python main.py -io_speed 40 -cap 20 -k_net 5 -p_net 1 -k_local 17 -p_local 3  -total_drives 120 -drives_per_rack 120 -spool_size 120 -placement=SLEC_LOCAL_DP -concur=256 -iter=100000 -afr=1 -sim_mode=1 -interrack_speed=20000 -num_net_fail_to_report=0 -num_local_fail_to_report=2 -detection_time=30 -repair_scheme=0

python main.py -io_speed 40 -cap 20 -k_net 5 -p_net 1 -k_local 17 -p_local 3  -total_drives 120 -drives_per_rack 120 -spool_size 120 -placement=SLEC_LOCAL_DP -concur=256 -iter=100000 -afr=1 -sim_mode=1 -interrack_speed=20000 -num_net_fail_to_report=0 -num_local_fail_to_report=3 -detection_time=30 -repair_scheme=0 -prev_fail_reports_filename=true
...
echo “mlec_c_d rs3”
python main.py -io_speed 40 -cap 20 -k_net 20 -p_net 4 -k_local 17 -p_local 3  -total_drives 57600 -drives_per_rack 960 -spool_size 120 -placement=MLEC_C_D -concur=256 -iter=40000 -afr=1 -sim_mode=1 -interrack_speed=2 -num_net_fail_to_report=5 -num_local_fail_to_report=0 -detection_time=30 -repair_scheme=3 --manual_spool_fail -prev_fail_reports_filename=true