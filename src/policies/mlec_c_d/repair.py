...
def mlec_c_d_repair(mlec_c_d, repair_queue):
    ...
    for spoolId in mlec_c_d.affected_spools:
        ...
        if spool.disk_max_priority <= mlec_c_d.sys.m:
    ...
    for rackgroupId in mlec_c_d.affected_rackgroups:
        rackgroup = mlec_c_d.rackgroups[rackgroupId]
