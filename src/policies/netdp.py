...
class NetDP:
    ...
    def update_disk_repair_time(self, diskId, priority, fail_per_stripe, failed_disk_system_tuple):
        ...
        if repaired_time == 0:
            ...
            priority_percent = netdp_prio.priority_percent(len(self.state.racks), len(self.state.disks)/len(self.state.racks), self.state.n, disk, failed_disk_per_rack, failed_racks)
        ...
        repair_time = self.calc_repair_time(disk, failed_racks, priority, failed_racks)
    ...
    def calc_repair_time(self, disk, failed_racks, priority, fail_per_stripe):
