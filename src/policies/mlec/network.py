...
def update_network_state(disk: Disk, fail_per_diskgroup: List[int], mlec: MLEC):
...
def update_network_state_diskgroup(diskgroup: Diskgroup, fail_per_stripeset: List[int], mlec: MLEC):
