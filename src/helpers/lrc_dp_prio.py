...
def compute_priority_percent(state, affected_racks, curr_rackId, priority):
    ...
    priority_cases = stripe_fail_cases(state.sys.total_chunks-1, priority-1, state.sys.num_disks_per_rack, failures_per_other_affected_rack_list, 
                                        state.sys.num_racks - 1 - len(failures_per_other_affected_rack_list))
    total_cases = stripe_total_cases(state.sys.total_chunks-1, state.sys.num_racks-1, state.sys.num_disks_per_rack)
