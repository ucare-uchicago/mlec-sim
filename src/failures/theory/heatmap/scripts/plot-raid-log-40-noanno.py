...
plt.yticks([0,10,20,30,40],fontsize=tick_font_size)
...
c_map_ax = figure.add_axes([0.142, 0.745, 0.74, 0.015])
...
plt.savefig(sys.argv[1] + '.60.noannotation.png',  bbox_inches='tight')