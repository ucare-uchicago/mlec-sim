...
set title "Probability of data loss vs failed disks # for local Declustered 8+2\n40 racks, each rack contains 800 disks"
...
'./sim-2rack.txt'  u ($3):($5 == 0 ? 0.000001 : $5) title "simulator 2 racks" w p lw 5 ps 1.5 pt 7 lc rgb 'orange', \
'./theory-4rack.txt'  u ($3):($5 == 0 ? 0.000001 : $5) title "theory 4 racks" w lp lw 5 ps 0 pt 7 lc rgb 'green', \
'./sim-4rack.txt'  u ($3):($5 == 0 ? 0.000001 : $5) title "simulator 4 racks" w p lw 5 ps 1.5 pt 7 lc rgb 'purple', \